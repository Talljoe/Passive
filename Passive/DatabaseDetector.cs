...
namespace Passive
{
    ...
    public class DatabaseDetector : IDatabaseDetector
    {
        ...
        /// </summary>
        public DatabaseDialect Probe(IDynamicDatabase database, string providerName, string connectionString)
        {
            switch (providerName)
            {
        ...
        private static DatabaseDialect ProbeSqlServer(IDynamicDatabase database)
        {
